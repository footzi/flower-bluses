                    ...
                    <div className="lessons-info-more">
                        <div className="lessons-info-more-text">
                            <img className="about-introduction-marker lessons-info-more-marker" src="/images/marker.png" />
                             1. Занятия будут проводиться в небольших группах. Максимальное количество участников - 4 человека.
                        </div>
                        <div className="lessons-info-more-text">
                            <img className="about-introduction-marker lessons-info-more-marker" src="/images/marker.png" />
                            2. Все необходимые материалы и фурнитура для создания украшений с реалистичными цветами предоставляются. Вам дополнительно докупать ничего не требуется. 
                        </div>
                        <div className="lessons-info-more-text">
                            <img className="about-introduction-marker lessons-info-more-marker" src="/images/marker.png" />
                            3. С завершенного МК, вы будете уходить с полностью готовой работой. Это может быть просто реалистический цветок, который можно будет поставить в вазу, или это будет брошка, или небольшая заколка - зажим. 
                        </div>
                        <div className="lessons-info-more-text">
                            <img className="about-introduction-marker lessons-info-more-marker" src="/images/marker.png" />
                             4. Участие в мастер-классах осуществляется по предварительной записи. Вы можете оставить свою заявку с помощью <Link className="link-contacts" to="/contacts">формы обратной связи</Link> или позвонив по телефону: +79038482661. 
                        </div>
                    </div>
                </div>
