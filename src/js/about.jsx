		...
		return (
			<div className="about">
				...
				<div className="about-more">
					<p><b>Безумно интересно взяв любой цветок, изучив его строение, его цвет,  разобрав для этого его до мельчайших  лепестков и чашелистиков, попытаться слепить подобный…. А когда удается передать мельчайшие подробности строения и  оттенки  - цветок начинает Жить. </b></p>
