...
<div className="list-items">
    ...
    <div>
        <div className="catalog-navbar">
            <ul>
                <Link to="/catalog/polimer/all" activeClassName="active-link" className="Link" onClick={this.onClick}><li>Все</li></Link> 
                <Link to="/catalog/polimer/pendants" activeClassName="active-link" className="Link" onClick={this.onClick}><li>Кулоны/подвески</li></Link>
