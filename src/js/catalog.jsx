...
<div className="catalog">
     ...
     <div className="catalog-greeting">
        ...
        <h1 className="catalog-introduction">Здесь Вы найдете нежные и изящные украшения и цветочные композиции ручной работы, <br/> которые будут радовать Вас своей свежестью и красатой круглый год!</h1>
     ...
     <div className="catalog-info">
            ...
            <h2 className="catalog-info-title">ПОЛИМЕРНАЯ ГЛИНА</h2>
            ...
            <h3 className="catalog-info-recomendation">Рекомендации по уходу</h3>
